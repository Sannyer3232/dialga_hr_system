# Generated by Django 5.2.13 on 2026-04-26 20:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education_level', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='employees.educationlevel', verbose_name='Education level')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collaborator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='familiar_profile', to='employees.collaborator')),
            ],
        ),
        migrations.CreateModel(
            name='HealthProfile',
            fields=[
                ...
                ('collaborator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='health_profile', to='employees.collaborator')),
            ],
        ),
    ]
